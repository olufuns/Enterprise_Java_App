...
curl -Ls https://download.newrelic.com/install/newrelic-cli/scripts/install.sh | bash && sudo NEW_RELIC_API_KEY=var.api_key NEW_RELIC_ACCOUNT_ID=var.account_id NEW_RELIC_REGION=EU /usr/local/bin/newrelic install -y
